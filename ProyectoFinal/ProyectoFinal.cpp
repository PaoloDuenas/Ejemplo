#include "iostream"                                                     //Proyecto Final Paolo Dueñas//
#include "string"
#include "string.h"
...
void NombreCantidadPrecio(char cantProductos[100][100], int n)
{
    ...
    cout << " Digite el nombre, cantidad y precio del producto " << endl;   //cin de los articulos
    for (int i = 0; i < n; i++){
    ...
    for(int i= 0; i < n; i++){                                                      //multiplicacion de los articulos
        listado[i].costoPorArticulo = listado[i].cantidad * listado[i].precio;
    }

    for(int i= 0; i < n; i++){
        Total = Total + listado[i].costoPorArticulo; //total de los articulos
    }

    cout << endl << " Recibo total: " << endl; //despliegue
    for(int i = 0; i < n; i++){
